...
namespace LabAss3
{
    public partial class frmCustomerDataEntry : Form
    {
        ...
        {
            string strConnection = "Data Source=LAPTOP-U075TJSD;Initial Catalog=CustomerDB;Integrated Security=True;Pooling=False";
        ...
        {
            string Gender, Hobby, Status = "Data Source=LAPTOP-U075TJSD;Initial Catalog=CustomerDB;Integrated Security=True;Pooling=False";
            if (radioMale.Checked) Gender = "Male";
            else Gender = "Female";
