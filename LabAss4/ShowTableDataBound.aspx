...
<br />
        ...
        <div>
            ...
            <p>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SampleDatabseConnectionString %>" SelectCommand="SELECT [Username], [password] FROM [Login]"></asp:SqlDataSource>
            </p>
        </div>
    </form>
</body>
